...
export default function DetailsNews({ tag,isTrue, Title }) {
    return (
        <div className={`flex overflow-hidden bg-[#465392] rounded-[40px] flex-col gap-10 h-[500px] w-11/12 items-center  pt-20 justify-center max-w-[1280px] ${isTrue ? "bg-image h-[700px]" : "bg-current md:gap-14 relative boxEffect md:!h-[414px]"}`}>
