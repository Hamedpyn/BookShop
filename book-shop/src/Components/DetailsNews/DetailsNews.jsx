...
export default function DetailsNews({ tag,isTrue, Title }) {
    return (
        <div className={`flex overflow-hidden bg-[#465392] z-50 rounded-[40px] flex-col gap-10 h-[500px] w-11/12 items-center justify-center max-w-[1280px] ${isTrue ? "bg-image pt-20" : "bg-current py-14 gap-14 relative boxEffect h-[414px]"}`}>
