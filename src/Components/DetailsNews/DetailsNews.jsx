...
export default function DetailsNews({ tag,isTrue, Title }) {
    return (
        <div className={`flex overflow-hidden bg-[#465392] rounded-[40px] flex-col gap-10 h-[500px] w-11/12 items-center  pt-20 justify-center max-w-[1280px] ${isTrue ? "bg-image h-[700px] sm:h-[550px]" : "bg-current md:gap-14 relative boxEffect md:!h-[414px]"}`}>
            ...
            <h2 className="kalameh w-[71%] line text-center leading-tight text-white text-4xl sm:text-6xl">
            ...
            {isTrue ? (
                ...
                <div className="flex flex-col-reverse items-center joinInput lg:w-2/4 rounded-full gap-2 mb-5">
                    ...
                    <input style={{all:"unset"}} placeholder="ایمیل خود را وارد کنید ..." type="text" disabled className="light !w-full !py-4 !pl-2 !pr-5 !bg-white !rounded-full !text-sm" />
                </div>
            )}
        </div>
    )
